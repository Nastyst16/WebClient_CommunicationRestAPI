...
#define SERVER_IP "54.170.241.232"
...
int main(int argc, char *argv[])
{
    ...
    message = compute_get_request(SERVER_IP, SERVER_API, NULL, NULL, 0);
    ...
    message = compute_post_request("54.170.241.232:8080", SERVER_API, "application/x-www-form-urlencoded",data, 2, NULL, 0);
    ...
    login = strdup("connect.sid=s%3A0XyiM7tGD1hy83Ij706jtu0vWAjR_SPn.1Y4u5OngpdQjRha%2FzFh56pwkBrDU0geiBxeDREa7whk");
    cookies[0] = login;

    message = compute_post_request("54.170.241.232:8080", "/api/v1/auth/login", "application/x-www-form-urlencoded", data, 2, cookies, 1);
    ...
    cookies[0] = login;
    message = compute_get_request("54.170.241.232:8080", "/api/v1/weather/key", NULL, cookies, 1);
    ...
    message = compute_get_request("54.170.241.232:8080", "/api/v1/auth/logout", NULL, NULL, 0);
